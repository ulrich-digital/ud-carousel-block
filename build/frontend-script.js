...
document.addEventListener("DOMContentLoaded", () => {
  ...
  carousels.forEach(carouselEl => {
    ...
    const baseSlidesPerView = parseInt(carouselEl.dataset.slidesPerView) || 1;
    const loopEnabled = carouselEl.dataset.loop === "true";
    const autoplayEnabled = carouselEl.dataset.autoplay === "true";
    const autoplaySpeed = parseInt(carouselEl.dataset.autoplaySpeed) || 3000;
    ...
    \* =============================================================== */
    const swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](swiperContainer, {
      watchOverflow: false,
      loop: loopEnabled,
      ...
      pagination: carouselEl.dataset.pagination === "true" ? {
